    ...
    <div className="search-results-content">
      {isLoading && (
        <>
          ...
          <SummaryData searchData={searchData} isLoading={isLoading} setIsLoading={setIsLoading}/>
          </>
      )}
      
      {!isLoading && isError && (
        <>
          <SummaryData searchData={searchData} isLoading={isLoading} setIsLoading={setIsLoading} isError={isError}/>
        </>
      )}
      ...
      {!isLoading && !isError && (
        <>
          <SummaryData searchData={searchData} isLoading={isLoading} setIsLoading={setIsLoading} isError={isError}/>
          <CardsList documentsData={documentsData}/>
        </>
      )}
    </div>
  );
